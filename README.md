...
<b><label>Resolution Type </label></b><br>
				
					<input type="checkbox" name="x">Retina HD Display<br>

<br><br>

<b><label>Type </label></b><br>
				
					<input type="checkbox" name="x">Smartphone<br>

<br><br>
<b><label>Availability </label></b><br>
				
					<input type="checkbox" name="x">Exclude Out of Stock <br>

<br><br>
<b><label>Features </label></b><br>
				
					<input type="checkbox" name="x">HD Recording<br>
					<input type="checkbox" name="x">NFC<br>
					<input type="checkbox" name="x">WiFi<br>
...
<input type="submit" name=""><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
  ...
  <table border="0" width="85%" cellpadding="15" cellspacing="0" align="center">
            <tr>
              <td height="160" align="left" valign="middle" colspan="2">
              <font face="arial" size="2" color="#393535">
<img src="https://images-na.ssl-images-amazon.com/images/I/61itOh%2BJe8L._SL1024_.jpg" width="600">

<h2><font style="color: #436630">Apple iPhone 11 Pro (Midnight Green, 64 GB)</font></h2><hr style="color: #436630">
<p><b><font style="color: #78AE5C">Design: An Obsession over Details</font></b></p>
<p>
...
<b><font style="color: #78AE5C">Three Cameras That Feel Like One</font></b><p>
...
<p>
<b><font style="color: #78AE5C">4K Video: The Highest Video Quality in a Smartphone</font></b></p>
<p>Shoot 4K video with an extended dynamic range at 60 fps. Capture four times more scene. And edit with new tools like rotate, crop and filters.</p>

<p><b><font style="color: #78AE5C">Night Mode - High Tech Meets Low Light</font></b></p>
<p>From dimly lit restaurants to sunsets on the beach, the new Night mode delivers natural low-light shots - automatically.</p>

<p><b><font style="color: #78AE5C">Lots More Power. Lots More Battery Life.</font></b></p>
<p>The fastest chip in a smartphone - A13 Bionic chip with Neural Engine. Fast-charge capable with the included 18 W adapter, the iPhone 11 Pro provides all-day battery life.</p>

<p><b><font style="color: #78AE5C">Privacy is Built-in</font></b></p>

<p>Face ID is one of the most secure facial authentication methods in a smartphone. And it doesn’t store or share your photo. Because with the iPhone, your privacy comes first.</p>
</font>
</td>
</tr>
</table>
...
<div style="width: 30%; margin: 0.5%; height: 1100px; overflow-y: scroll; float: right; padding-top: 20px; ">
  <a class="twitter-timeline" href="https://twitter.com/flipkart?lang=en"></a>

<blockquote class="twitter-tweet"><a href="https://twitter.com/FlipkartVideo?ref_src=twsrc%5Etfw">@FlipkartVideo</a> <a href="https://t.co/kWyMhGAMgs">pic.twitter.com/kWyMhGAMgs</a></p>&mdash; Flipkart (@Flipkart)</a></blockquote>
<script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
</div>

<div style="width: 700px; color: #443A39;float: left; background-color: #FCBEB6 ">
				<img src="https://rukminim1.flixcart.com/image/312/312/k9loccw0/mobile/6/b/z/apple-iphone-se-mxd12hn-a-original-imafrcqfsuzwa3dz.jpeg?q=70" swidth="150" align="left" height="175">
